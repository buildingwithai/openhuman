...
fn get_router() -> Result<std::sync::Arc<crate::benito::webhooks::WebhookRouter>, String> {
    crate::benito::socket::global_socket_manager()
...
pub async fn trigger_agent(
    ...
    use crate::benito::agent::triage::TriggerEnvelope;
    ...
    let outcome = tokio::time::timeout(
        ...
        crate::benito::agent::triage::run_triage(&envelope),
    )
    .await
...
pub fn build_echo_response(request: &WebhookRequest) -> WebhookResponseData {
    ...
    headers.insert("x-Benito-webhook-target".to_string(), "echo".to_string());
