...
use crate::benito::voice::{create_tts_provider, DEFAULT_PIPER_VOICE};
...
const EMAIL_CAPTURE_ENV: &str = "BENITO_EMAIL_CAPTURE_DIR";
...
fn build_email_message(
    ...
    let from_address = config
        ...
        .filter(|s| !s.is_empty())
        .unwrap_or("Benito@localhost.test");
...
mod tests {
    ...
    fn test_config() -> Config {
        ...
        config.workspace_dir = std::env::temp_dir().join("Benito-audio-toolkit-tests");
