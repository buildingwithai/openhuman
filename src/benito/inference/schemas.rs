...
pub fn schemas(function: &str) -> ControllerSchema {
    match function {
        ...
        "update_model_settings" => ControllerSchema {
            ...
            inputs: vec![
                optional_string("api_url", "Optional Benito product backend URL."),
...
fn handle_inference_status(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::benito::inference::rpc::inference_status(&config).await?)
    })
}

fn handle_inference_get_client_config(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        to_json(crate::benito::inference::rpc::inference_get_client_config().await?)
    })
}
    ...
    Box::pin(async move {
        ...
        let patch = config_rpc::ModelSettingsPatch {
            ...
            model_routes: update.model_routes.map(|routes| {
                routes
                    .into_iter()
                    .map(|route| crate::benito::config::ModelRouteConfig {
                        hint: route.hint,
                        model: route.model,
                    })
                    .collect()
        ...
        to_json(crate::benito::inference::rpc::inference_update_model_settings(patch).await?)
    })
}
...
fn handle_inference_update_local_settings(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::benito::inference::rpc::inference_update_local_settings(patch).await?)
    })
}
...
fn handle_inference_list_models(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::benito::inference::rpc::inference_list_models(&request.provider_id).await?,
        )
    })
}
...
fn handle_inference_device_profile(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(
        async move { to_json(crate::benito::inference::rpc::inference_device_profile().await?) },
    )
}

fn handle_inference_presets(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move { to_json(crate::benito::inference::rpc::inference_presets().await?) })
}
...
fn handle_inference_apply_preset(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::benito::inference::rpc::inference_apply_preset(&request.tier).await?)
    })
}
...
fn handle_inference_diagnostics(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(crate::benito::inference::rpc::inference_diagnostics(&config).await?)
    })
}
...
fn handle_inference_summarize(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(
            crate::benito::inference::rpc::inference_summarize(&config, &p.text, p.max_tokens)
                .await?,
        )
    })
}
...
fn handle_inference_prompt(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(
            crate::benito::inference::rpc::inference_prompt(
                &config,
                &p.prompt,
                p.max_tokens,
                p.no_think,
...
fn handle_inference_vision_prompt(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(
            crate::benito::inference::rpc::inference_vision_prompt(
                &config,
                &p.prompt,
                &p.image_refs,
                p.max_tokens,
...
fn handle_inference_embed(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(crate::benito::inference::rpc::inference_embed(&config, &p.inputs).await?)
    })
}
...
fn handle_inference_chat(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let messages = p
            ...
            .into_iter()
            .map(
                |message| crate::benito::inference::local::ops::LocalAiChatMessage {
                    role: message.role,
            ...
            .collect();
        to_json(
            crate::benito::inference::rpc::inference_chat(&config, messages, p.max_tokens)
                .await?,
        )
    })
}
...
fn handle_inference_should_react(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(
            crate::benito::inference::rpc::inference_should_react(
                &config,
                &p.message,
                &p.channel_type,
            )
...
fn handle_inference_analyze_sentiment(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(
            crate::benito::inference::rpc::inference_analyze_sentiment(&config, &p.message)
                .await?,
        )
    })
}
