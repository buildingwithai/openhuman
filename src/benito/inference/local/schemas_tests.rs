...
async fn install_whisper_handler_serializes_concurrent_calls() {
    ...
    // the network in CI.
    let slot = crate::benito::inference::local::voice_install_common::try_acquire_install_slot(
    ...
    crate::benito::inference::local::voice_install_common::write_status(
        crate::benito::inference::local::voice_install_common::VoiceInstallStatus {
            engine: crate::benito::inference::local::voice_install_common::ENGINE_WHISPER.to_string(),
            state: crate::benito::inference::local::voice_install_common::VoiceInstallState::Installing,
            progress: Some(0),
    ...
    crate::benito::inference::local::voice_install_common::reset_status(
        crate::benito::inference::local::voice_install_common::ENGINE_WHISPER,
    );
