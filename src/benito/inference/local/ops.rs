...
use crate::benito::inference::provider as providers;
use crate::benito::inference::provider::ops::ProviderRuntimeOptions;
use crate::benito::inference::{
...
pub async fn agent_chat_simple(
    ...
    let options = ProviderRuntimeOptions {
        ...
        BENITO_dir: effective.config_path.parent().map(std::path::PathBuf::from),
...
pub async fn local_ai_transcribe_bytes(
    ...
    let voice_dir = std::env::temp_dir().join("BENITO_voice_input");
...
pub async fn local_ai_chat(
    ...
    let mut ollama_messages: Vec<crate::benito::inference::local::ollama::OllamaChatMessage> =
    ...
    for msg in messages.into_iter() {
        ...
        ollama_messages.push(
            crate::benito::inference::local::ollama::OllamaChatMessage {
