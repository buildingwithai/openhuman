...
use crate::benito::inference::local::lm_studio::{
...
use crate::benito::inference::local::ollama::OllamaModelTag;
...
pub(in crate::benito::inference::local::service) struct LmStudioCompletionOutcome {
    pub reply: String,
...
impl LocalAiService {
    pub(in crate::benito::inference::local::service) async fn ensure_lm_studio_available(
        &self,
        config: &Config,
    ) -> Result<(), String> {
    ...
    pub(in crate::benito::inference::local::service) async fn list_lm_studio_models(
        &self,
        config: &Config,
    ...
    pub(in crate::benito::inference::local::service) async fn has_lm_studio_model(
        &self,
        config: &Config,
        model: &str,
    ) -> Result<bool, String> {
    ...
    pub(in crate::benito::inference::local::service) async fn lm_studio_chat_completion(
        &self,
        config: &Config,
