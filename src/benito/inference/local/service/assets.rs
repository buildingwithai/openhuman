...
use crate::benito::inference::paths::{
...
use crate::benito::inference::types::{
...
impl LocalAiService {
    pub async fn assets_status(&self, config: &Config) -> Result<LocalAiAssetsStatus, String> {
        ...
        // External-runtime precondition: Benito no longer installs or
    ...
    pub(in crate::benito::inference::local::service) async fn ensure_stt_asset_available(
        &self,
        config: &Config,
    ) -> Result<(), String> {
    ...
    pub(in crate::benito::inference::local::service) async fn ensure_tts_asset_available(
        &self,
        config: &Config,
    ) -> Result<(), String> {
