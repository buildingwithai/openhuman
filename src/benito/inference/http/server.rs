...
//! ## Authentication
//!
//! All routes require `Authorization: Bearer <benito_core_TOKEN>` — the
...
//! - everything else → Benito backend (session JWT)
...
async fn chat_completions_handler(
    ...
    let temperature = {
        ...
        let suppressed = crate::benito::inference::provider::temperature::temperature_for_model(
            &model_id, raw, &config,
        );
