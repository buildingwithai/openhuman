#[cfg(test)]
mod tests {
    use crate::benito::subconscious::decision_log::DecisionLog;
    use crate::benito::subconscious::store;
    use crate::benito::subconscious::types::{
    ...
    fn engine_construction_seeds_default_tasks() {
        use crate::benito::config::HeartbeatConfig;
        use crate::benito::subconscious::SubconsciousEngine;
