    ...
    match function {
        ...
        "reflections_act" => ControllerSchema {
            ...
            description: "Act on a reflection — creates a fresh conversation thread \
                 ...
                 observation from Benito, ready for them to reply. Marks \
...
fn handle_reflections_act(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        crate::benito::memory::conversations::ensure_thread(
            config.workspace_dir.clone(),
            crate::benito::memory::conversations::CreateConversationThread {
                id: thread_id.clone(),
                title: thread_title,
        ...
        // sent from `assistant` (i.e. Benito speaking). The frontend
        ...
        let seed_message = crate::benito::memory::conversations::ConversationMessage {
        ...
        crate::benito::memory::conversations::append_message(
            config.workspace_dir.clone(),
            &thread_id,
            seed_message,
        )
...
async fn load_config() -> Result<crate::benito::config::Config, String> {
    ...
    crate::benito::config::load_config_with_timeout().await
}
