...
fn resolve_one(config: &crate::benito::config::Config, raw: &str) -> SourceChunk {
...
/// [`crate::benito::subconscious::situation_report::summaries`] but
...
fn resolve_summary(config: &crate::benito::config::Config, raw: &str) -> SourceChunk {
    ...
    let lookup: anyhow::Result<Option<(String, i64, String)>> =
        crate::benito::memory::tree::store::with_connection(config, |conn| {
...
fn resolve_entity(config: &crate::benito::config::Config, raw: &str) -> SourceChunk {
