...
use super::*;
use crate::benito::subconscious::reflection::{hydrate_draft, ReflectionDraft, ReflectionKind};
...
fn fresh_conn() -> Connection {
    ...
    conn.execute_batch(crate::benito::subconscious::store::SCHEMA_DDL_FOR_TESTS)
        .expect("apply DDL");
    conn
}
