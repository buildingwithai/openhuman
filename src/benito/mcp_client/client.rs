use crate::benito::config::{McpAuthConfig, McpClientIdentityConfig};
use crate::benito::skills::types::ToolResult;
use anyhow::Context;
use base64::Engine;
...
impl McpHttpClient {
    ...
    pub fn with_options(
        ...
        let builder =
            crate::benito::config::apply_runtime_proxy_to_builder(builder, "tool.mcp_client");
