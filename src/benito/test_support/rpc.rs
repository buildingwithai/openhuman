//! Implementation of `Benito.test_reset` — wipes persistent state in-place.
//!
...
use crate::benito::config::{clear_active_user, default_root_BENITO_dir};
...
pub async fn reset() -> Result<RpcOutcome<ResetSummary>, String> {
    ...
    let root = default_root_BENITO_dir()
