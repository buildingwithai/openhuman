...
// ── Redirect resolution (the real fix for Benito-TAURI-9X) ──
...
/// Regression guard for Benito-TAURI-BH: the exact wire shape the
...
/// any expected kind. Pins the Benito-TAURI-8M invariant ("one event
