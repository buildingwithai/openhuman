...
///
/// See Benito-TAURI-8M — a single gateway 503 incident generated 549
...
fn log_connection_failure(consecutive: u32, reason: &str) {
    if consecutive == FAIL_ESCALATE_THRESHOLD {
        ...
        // / `Network is unreachable (os error 51)` — see Benito-TAURI-BH)
        ...
        // event per affected client, preserving the Benito-TAURI-8M intent.
        let detailed = format!(
