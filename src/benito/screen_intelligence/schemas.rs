...
fn handle_status(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async {
        to_json(crate::benito::screen_intelligence::rpc::accessibility_status().await?)
    })
}
...
fn handle_request_permissions(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async {
        to_json(
            crate::benito::screen_intelligence::rpc::accessibility_request_permissions().await?,
        )
    })
}
...
fn handle_refresh_permissions(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async {
        to_json(
            crate::benito::screen_intelligence::rpc::accessibility_refresh_permissions().await?,
        )
    })
}
...
fn handle_request_permission(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::benito::screen_intelligence::rpc::accessibility_request_permission(payload)
                .await?,
        )
    })
}
...
fn handle_start_session(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::benito::screen_intelligence::rpc::accessibility_start_session(payload)
                .await?,
        )
    })
}
...
fn handle_stop_session(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::benito::screen_intelligence::rpc::accessibility_stop_session(payload).await?,
        )
    })
}
...
fn handle_capture_now(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async {
        to_json(crate::benito::screen_intelligence::rpc::accessibility_capture_now().await?)
    })
}
...
fn handle_capture_image_ref(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async {
        to_json(
            crate::benito::screen_intelligence::rpc::accessibility_capture_image_ref().await?,
        )
    })
}
...
fn handle_input_action(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::benito::screen_intelligence::rpc::accessibility_input_action(payload).await?,
        )
    })
}
...
fn handle_vision_recent(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::benito::screen_intelligence::rpc::accessibility_vision_recent(payload.limit)
                .await?,
        )
    })
}
...
fn handle_vision_flush(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async {
        to_json(crate::benito::screen_intelligence::rpc::accessibility_vision_flush().await?)
    })
}

fn handle_capture_test(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async {
        to_json(crate::benito::screen_intelligence::rpc::accessibility_capture_test().await?)
    })
}
...
fn handle_globe_listener_start(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async {
        to_json(
            crate::benito::screen_intelligence::rpc::accessibility_globe_listener_start()
                .await?,
        )
    })
}
...
fn handle_globe_listener_poll(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async {
        to_json(
            crate::benito::screen_intelligence::rpc::accessibility_globe_listener_poll().await?,
        )
    })
}
...
fn handle_globe_listener_stop(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async {
        to_json(
            crate::benito::screen_intelligence::rpc::accessibility_globe_listener_stop().await?,
        )
    })
}
