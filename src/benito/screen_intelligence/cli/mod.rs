//! `Benito screen-intelligence` — standalone CLI for the screen intelligence loop.
//!
...
//!
//! Usage:
//!   Benito screen-intelligence run       [--ttl <secs>] [--keep] [-v]
//!   Benito screen-intelligence status    [-v]
//!   Benito screen-intelligence capture   [--keep] [-v]
//!   Benito screen-intelligence start     [--ttl <secs>] [-v]
//!   Benito screen-intelligence stop      [-v]
//!   Benito screen-intelligence doctor    [-v]
//!   Benito screen-intelligence vision    [--limit <n>] [-v]
...
/// Entry point for `Benito screen-intelligence <subcommand>`.
pub(crate) fn run_screen_intelligence_command(args: &[String]) -> Result<()> {
    ...
    match args[0].as_str() {
        ...
        other => Err(anyhow::anyhow!(
            "unknown screen-intelligence subcommand '{other}'. Run `Benito screen-intelligence --help`."
        )),
    }
}
...
pub(super) async fn bootstrap_engine(
    verbose: bool,
) -> Result<Arc<crate::benito::screen_intelligence::AccessibilityEngine>> {
...
pub(super) async fn bootstrap_engine_with_opts(
    ...
    use crate::benito::screen_intelligence::global_engine;
...
fn print_help() {
    println!("Benito screen-intelligence — standalone screen intelligence runtime\n");
    ...
    println!("Usage:");
    println!("  Benito screen-intelligence run       [--ttl <secs>] [--no-vision-model] [-v]");
    println!("  Benito screen-intelligence status     [-v]");
    println!("  Benito screen-intelligence capture    [--keep] [-v]");
    println!("  Benito screen-intelligence start      [--ttl <secs>] [--no-vision-model] [-v]");
    println!("  Benito screen-intelligence stop       [-v]");
    println!("  Benito screen-intelligence doctor     [-v]");
    println!("  Benito screen-intelligence vision     [--limit <n>] [-v]");
    println!();
    println!("Subcommands:");
