use crate::benito::config::ScreenIntelligenceConfig;
use serde::{Deserialize, Serialize};

// Permission types are defined in the accessibility middleware; re-export for compatibility.
pub use crate::benito::accessibility::{GlobeHotkeyPollResult, GlobeHotkeyStatus};
pub use crate::benito::accessibility::{PermissionKind, PermissionState, PermissionStatus};
