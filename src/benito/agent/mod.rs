...
//!
//! This domain owns the core "brain" of Benito. It coordinates how LLMs
...
/// `benito::context::prompt` so prompt rendering lives next to the
/// agents that consume it. `benito::context::prompt` is retained as
