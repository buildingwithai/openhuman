use super::*;
use crate::benito::approval::ApprovalManager;
use crate::benito::config::AutonomyConfig;
use crate::benito::inference::provider::traits::ProviderCapabilities;
use crate::benito::inference::provider::ChatResponse;
use crate::benito::security::AutonomyLevel;
use crate::benito::tools::{ToolResult, ToolScope};
...
async fn run_tool_call_loop_aborts_when_stop_hook_returns_stop() {
    use crate::benito::agent::stop_hooks::{with_stop_hooks, StopDecision, StopHook, TurnState};
...
async fn run_tool_call_loop_applies_per_tool_max_result_size_cap() {
    ...
    impl Tool for CappedHugeTool {
        ...
        fn permission_level(&self) -> crate::benito::tools::PermissionLevel {
            crate::benito::tools::PermissionLevel::ReadOnly
        }
    ...
    assert!(
        ...
        crate::benito::util::utf8_safe_prefix_at_byte_boundary(&tool_results.content, 200)
    );
    assert!(
