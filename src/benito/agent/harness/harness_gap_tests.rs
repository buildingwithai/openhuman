...
use crate::benito::agent::harness::tool_loop::run_tool_call_loop;
use crate::benito::context::guard::{ContextCheckResult, ContextGuard};
use crate::benito::inference::provider::traits::ProviderCapabilities;
use crate::benito::inference::provider::Provider;
use crate::benito::inference::provider::{ChatMessage, ChatRequest, ChatResponse, UsageInfo};
use crate::benito::tool_timeout::parse_tool_timeout_secs;
...
fn multimodal_cfg() -> crate::benito::config::MultimodalConfig {
...
async fn max_iterations_exceeded_downcasts_to_typed_agent_error() {
    ...
    assert!(
        crate::benito::agent::error::is_max_iterations_error(&err.to_string()),
...
fn parse_tool_calls_invoke_tag_with_json_body() {
    use crate::benito::agent::harness::parse::parse_tool_calls;
...
fn datetime_section_output_matches_iso8601_date_and_utc_offset_pattern() {
    use crate::benito::agent::prompts::{DateTimeSection, PromptContext, PromptSection};
    use std::collections::HashSet;
    use std::path::Path;
    use std::sync::LazyLock;

    static EMPTY_FILTER: LazyLock<HashSet<String>> = LazyLock::new(HashSet::new);
    static EMPTY_TOOLS: &[crate::benito::agent::prompts::PromptTool<'static>] = &[];
    static EMPTY_INTEGRATIONS: &[crate::benito::context::prompt::ConnectedIntegration] = &[];
    ...
    let ctx = PromptContext {
        ...
        learned: crate::benito::agent::prompts::LearnedContextData::default(),
