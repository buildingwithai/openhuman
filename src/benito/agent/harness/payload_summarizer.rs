...
//! [`crate::benito::config::ContextConfig::tool_result_budget_bytes`],
...
//! ([`crate::benito::agent::harness::session::builder::AgentBuilder`]
...
/// [`crate::benito::agent::harness::session::Agent::execute_tool_call`]
...
pub struct SubagentPayloadSummarizer {
    ...
    /// [`crate::benito::config::ContextConfig`] (500 000 tokens).
    ...
    /// [`crate::benito::config::ContextConfig`] (2 000 000 tokens).
...
/// [`crate::benito::tree_summarizer::types::estimate_tokens`] but
