...
//! the [`crate::benito::tools::Tool`] trait.
//!
//! [`PARENT_CONTEXT`] is set by the parent
//! [`crate::benito::agent::Agent`] around its `turn` so that any tool
...
/// running inside [`crate::benito::agent::Agent::turn`] via the
...
pub struct ParentExecutionContext {
    ...
    pub connected_integrations: Vec<crate::benito::context::prompt::ConnectedIntegration>,
    ...
    pub tool_call_format: crate::benito::context::prompt::ToolCallFormat,
...
///
/// Returns `None` when called from outside [`crate::benito::agent::Agent::turn`]
