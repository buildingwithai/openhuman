...
use crate::benito::agent::dispatcher::ToolDispatcher;
use crate::benito::agent::harness::archivist::ArchivistHook;
use crate::benito::agent::hooks::PostTurnHook;
use crate::benito::agent::memory_loader::MemoryLoader;
use crate::benito::agent::progress::AgentProgress;
use crate::benito::agent::tool_policy::ToolPolicy;
use crate::benito::context::prompt::SystemPromptBuilder;
use crate::benito::context::ContextManager;
use crate::benito::inference::provider::{ChatMessage, ConversationMessage, Provider};
use crate::benito::memory::Memory;
use crate::benito::tools::{Tool, ToolSpec};
...
pub struct Agent {
    ...
    pub(super) config: crate::benito::config::AgentConfig,
    pub(super) model_name: String,
    pub(super) temperature: f64,
    pub(super) workspace_dir: std::path::PathBuf,
    pub(super) skills: Vec<crate::benito::skills::Skill>,
    ...
    pub(super) last_turn_citations: Vec<crate::benito::agent::memory_loader::MemoryCitation>,
    ...
    ///
    /// [`AgentDefinitionRegistry`]: crate::benito::agent::harness::definition::AgentDefinitionRegistry
    ...
    /// [`crate::benito::context`] for the full surface.
    ...
    /// integration blocks.
    pub(super) connected_integrations: Vec<crate::benito::context::prompt::ConnectedIntegration>,
    ...
    pub(super) payload_summarizer:
        Option<Arc<dyn crate::benito::agent::harness::payload_summarizer::PayloadSummarizer>>,
    ...
    /// [`crate::benito::composio::cached_active_integrations`]; on
    ...
    /// produced by [`crate::benito::tools::orchestrator_tools::collect_orchestrator_tools`]
...
pub struct AgentBuilder {
    ...
    pub(super) config: Option<crate::benito::config::AgentConfig>,
    /// Optional [`ContextConfig`] override threaded through from
    /// `Agent::from_config`. When unset the builder falls back to
    /// [`crate::benito::config::ContextConfig::default`].
    pub(super) context_config: Option<crate::benito::config::ContextConfig>,
    pub(super) model_name: Option<String>,
    pub(super) temperature: Option<f64>,
    pub(super) workspace_dir: Option<std::path::PathBuf>,
    pub(super) skills: Option<Vec<crate::benito::skills::Skill>>,
