use super::*;
use crate::benito::agent::hooks::{ToolCallRecord, TurnContext};
use crate::benito::memory::store::{events as ev, fts5, segments as seg};
...
use crate::benito::memory::tree::store::{count_chunks, list_chunks, ListChunksQuery};
    ...
    let closed = all_segs
        ...
        .find(|s| {
            s.session_id == session
                && s.status != crate::benito::memory::store::segments::SegmentStatus::Open
        })
