...
//! authoritative `charged_amount_usd` populated by the Benito
...
//!   [`crate::benito::agent::progress::AgentProgress::TurnCostUpdated`];
...
use crate::benito::inference::provider::UsageInfo;
...
///
/// These are the Benito tier handles, not concrete vendor model
