...
pub enum AgentProgress {
    ...
    /// from inside [`crate::benito::agent::harness::subagent_runner`]**
    ...
    /// `todo` tool (or `Benito.todos_*` RPC) after the board has been persisted.
    TaskBoardUpdated {
        board: crate::benito::agent::task_board::TaskBoard,
    },
    ...
    /// [`crate::benito::agent::cost::TurnCost::total_usd`].
    TurnCostUpdated {
