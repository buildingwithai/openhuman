...
use crate::benito::config::RuntimeConfig;
...
pub struct DockerRuntime {
    config: crate::benito::config::DockerRuntimeConfig,
}

impl DockerRuntime {
    fn new(config: crate::benito::config::DockerRuntimeConfig) -> Self {
        Self { config }
    }
}
...
mod tests {
    use super::*;
    use crate::benito::config::{DockerRuntimeConfig, RuntimeConfig};
    ...
    fn native_runtime_reports_capabilities_and_shell_command() {
        ...
        assert!(runtime.storage_path().ends_with("Benito/runtime"));
    ...
    fn docker_runtime_builds_expected_flags() {
        ...
        assert!(runtime.storage_path().ends_with("Benito/runtime/docker"));
