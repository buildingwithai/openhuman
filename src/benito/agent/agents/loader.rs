...
//! loader output.
//!
//! Workspace-level overrides (`$BENITO_WORKSPACE/agents/*.toml`) are
...
pub struct BuiltinAgent {
    ...
    /// with a populated [`crate::benito::agent::harness::definition::PromptContext`]
...
/// [`crate::benito::agent::harness::definition::AgentDefinitionRegistry::load`]
...
mod tests {
    use super::*;
    use crate::benito::agent::harness::definition::{ModelSpec, SandboxMode, ToolScope};
    ...
    fn orchestrator_subagents_include_crypto_agent() {
        use crate::benito::agent::harness::definition::SubagentEntry;
        let def = find("orchestrator");
    ...
    fn allows_skill_wildcards_on_any_non_worker_tier() {
        ...
        planner.subagents.push(SubagentEntry::Skills(
            crate::benito::agent::harness::definition::SkillsWildcard { skills: "*".into() },
        ));
