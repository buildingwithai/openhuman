...
/// Request payload for `Benito.whatsapp_data_ingest`.
#[derive(Debug, Deserialize)]
...
/// Request payload for `Benito.whatsapp_data_list_chats`.
#[derive(Debug, Deserialize)]
...
/// Request payload for `Benito.whatsapp_data_list_messages`.
#[derive(Debug, Deserialize)]
...
/// Request payload for `Benito.whatsapp_data_search_messages`.
#[derive(Debug, Deserialize)]
