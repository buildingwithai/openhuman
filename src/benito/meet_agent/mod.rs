...
//! ## RPC surface
//!
//! - `Benito.meet_agent_start_session`  — open a session for a `request_id`
//! - `Benito.meet_agent_push_listen_pcm` — shell pushes captured PCM frames
//! - `Benito.meet_agent_poll_speech`     — shell pulls synthesized PCM frames
//! - `Benito.meet_agent_stop_session`    — close session, flush pending audio
