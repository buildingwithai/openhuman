...
/// Inputs to `Benito.meet_agent_start_session`.
#[derive(Debug, Clone, Deserialize)]
pub struct StartSessionRequest {
    /// `request_id` minted by `Benito.meet_join_call`. Used as the
...
/// Outputs from `Benito.meet_agent_start_session`.
...
/// Inputs to `Benito.meet_agent_push_listen_pcm`.
///
...
/// Inputs to `Benito.meet_agent_poll_speech`.
///
...
/// Inputs to `Benito.meet_agent_push_caption`.
///
...
/// Inputs to `Benito.meet_agent_stop_session`.
#[derive(Debug, Clone, Deserialize)]
...
pub struct StopSessionResponse {
    ...
    /// for telemetry and the smoke test in [`crate::benito::meet_agent`].
