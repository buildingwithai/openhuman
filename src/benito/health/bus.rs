    ...
    async fn handle(&self, event: &DomainEvent) {
        match event {
            DomainEvent::SystemStartup { component } => {
                crate::benito::health::mark_component_ok(component);
            }
            DomainEvent::HealthChanged {
                ...
                if *healthy {
                    ...
                    crate::benito::health::mark_component_error(
                        component,
            ...
            DomainEvent::HealthRestarted { component } => {
                crate::benito::health::bump_component_restart(component);
            }
            DomainEvent::ChannelConnected { channel } => {
                crate::benito::health::mark_component_ok(&format!("channel:{channel}"));
            }
...
mod tests {
    ...
    async fn health_changed_false_records_error() {
        ...
        let snapshot = crate::benito::health::snapshot();
