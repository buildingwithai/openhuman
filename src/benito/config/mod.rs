//! Configuration management for the Benito core.
//!
...
pub use schema::{
    clear_active_user, default_root_BENITO_dir, pre_login_user_dir, read_active_user_id,
    user_BENITO_dir, write_active_user_id, PRE_LOGIN_USER_ID,
};
pub use schemas::{
...
/// `BENITO_WORKSPACE` env var so they serialize against one another.
...
mod tests {
    ...
    fn reexported_channel_configs_are_constructible() {
        ...
        let lark = LarkConfig {
            ...
            allowed_users: vec![],
            use_feishu: false,
            receive_mode: crate::benito::config::schema::LarkReceiveMode::Websocket,
            port: None,
        };
