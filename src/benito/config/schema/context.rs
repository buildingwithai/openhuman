...
//!
//! Knobs for the global `src/Benito/context/` module — budget
...
use crate::benito::context::session_memory::SessionMemoryConfig;
...
pub struct ContextConfig {
    /// Master switch. When `false`, [`crate::benito::context::ContextManager`]
...
fn default_microcompact_keep_recent() -> usize {
    crate::benito::context::DEFAULT_KEEP_RECENT_TOOL_RESULTS
}

fn default_tool_result_budget_bytes() -> usize {
    crate::benito::context::DEFAULT_TOOL_RESULT_BUDGET_BYTES
}
