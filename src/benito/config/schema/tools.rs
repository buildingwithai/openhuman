...
pub struct GitbooksConfig {
    ...
    pub enabled: bool,
    /// MCP endpoint URL for the Benito GitBook docs.
...
/// Benito backend (`api.tinyhumans.ai/agent-integrations/composio/*`).
...
pub struct ComposioConfig {
    ...
    /// [`COMPOSIO_MODE_BACKEND`] (default — proxied through the Benito
    ...
    /// [`crate::benito::credentials`] under the
...
///
/// Defaults to **Benito-managed** routing: the Benito backend
...
pub struct IntegrationToggle {
    ...
    /// Benito backend proxies the call) or [`INTEGRATION_MODE_BYO`]
