...
use crate::benito::channels::email_channel::EmailConfig;
...
pub struct ChannelsConfig {
    ...
    /// handler in [`crate::benito::channels::proactive`] always
...
impl ChannelsConfig {
    /// Whether [`crate::benito::channels::start_channels`] has any integrations to listen on.
