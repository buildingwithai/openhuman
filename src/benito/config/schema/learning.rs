...
pub struct LearningConfig {
    ...
    /// [`crate::benito::memory::tool_memory::ToolMemoryCaptureHook`]).
    ///
    ...
    ///
    /// Override via `BENITO_LEARNING_EPISODIC_CAPTURE_ENABLED=0|1`.
    #[serde(default = "default_true")]
    ...
    ///
    /// Override via `BENITO_LEARNING_STM_RECALL_ENABLED=0|1`.
    #[serde(default = "default_true")]
    ...
    ///
    /// Override via `BENITO_LEARNING_UNIFIED_COMPACTION_ENABLED=0|1`.
    #[serde(default = "default_true")]
    ...
    ///
    /// Explicitly set to `false` (or `BENITO_LEARNING_EXPLICIT_PREFERENCES_ENABLED=0`)
