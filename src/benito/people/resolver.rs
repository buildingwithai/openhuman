...
use crate::benito::people::address_book::{self, AddressBookError, ContactsSource};
use crate::benito::people::store::PeopleStore;
use crate::benito::people::types::{Handle, Person, PersonId};
...
mod tests {
    use super::*;
    use crate::benito::people::address_book::tests::MockContactsSource;
    use crate::benito::people::types::AddressBookContact;
