...
use crate::benito::credentials::rpc;
use crate::benito::credentials::APP_SESSION_PROVIDER;
...
mod tests {
    ...
    fn set_workspace(tmp: &TempDir) {
        ...
        // this module acquires before touching BENITO_WORKSPACE.
        unsafe {
    ...
    // by pointing `BENITO_WORKSPACE` at a temp dir and relying on
