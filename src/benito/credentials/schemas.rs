...
fn handle_auth_store_session(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::benito::credentials::rpc::store_session(
                &config,
                &payload.token,
                payload.user_id,
                payload.user,
...
fn handle_auth_clear_session(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(crate::benito::credentials::rpc::clear_session(&config).await?)
    })
}
...
fn handle_auth_get_state(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(crate::benito::credentials::rpc::auth_get_state(&config).await?)
    })
}
...
fn handle_auth_get_session_token(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(crate::benito::credentials::rpc::auth_get_session_token_json(&config).await?)
    })
}
...
fn handle_auth_get_me(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(crate::benito::credentials::rpc::auth_get_me(&config).await?)
    })
}
...
fn handle_auth_consume_login_token(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::benito::credentials::rpc::consume_login_token(
                &config,
...
fn handle_auth_create_channel_link_token(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::benito::credentials::rpc::auth_create_channel_link_token(
                &config,
...
fn handle_auth_store_provider_credentials(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::benito::credentials::rpc::store_provider_credentials(
                &config,
                &payload.provider,
...
fn handle_auth_remove_provider_credentials(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::benito::credentials::rpc::remove_provider_credentials(
                &config,
                &payload.provider,
                payload.profile.as_deref(),
            )
...
fn handle_auth_list_provider_credentials(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let provider_filter = payload
            ...
            .map(str::to_string);
        to_json(
            crate::benito::credentials::rpc::list_provider_credentials(&config, provider_filter)
                .await?,
        )
    })
}
...
fn handle_auth_oauth_connect(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::benito::credentials::rpc::oauth_connect(
                &config,
...
fn handle_auth_oauth_list_integrations(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(crate::benito::credentials::rpc::oauth_list_integrations(&config).await?)
    })
}
...
fn handle_auth_oauth_fetch_integration_tokens(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::benito::credentials::rpc::oauth_fetch_integration_tokens(
                &config,
...
fn handle_auth_oauth_fetch_client_key(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::benito::credentials::rpc::oauth_fetch_client_key(
                &config,
                payload.integration_id.trim(),
            )
            .await?,
...
fn handle_auth_oauth_revoke_integration(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::benito::credentials::rpc::oauth_revoke_integration(
                &config,
                payload.integration_id.trim(),
            )
            .await?,
