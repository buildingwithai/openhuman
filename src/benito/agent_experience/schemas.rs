...
use crate::benito::agent_experience::ops::{CaptureParams, DismissParams, RetrieveParams};
...
fn handle_capture(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::benito::agent_experience::ops::capture(params).await?)
    })
}
...
fn handle_retrieve(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::benito::agent_experience::ops::retrieve(params).await?)
    })
}

fn handle_list(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move { to_json(crate::benito::agent_experience::ops::list().await?) })
}

fn handle_dismiss(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let params = read_params::<DismissParams>(params)?;
        to_json(crate::benito::agent_experience::ops::dismiss(params).await?)
    })
}
