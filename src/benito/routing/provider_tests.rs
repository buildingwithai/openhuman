...
use crate::benito::routing::health::LocalHealthChecker;
use crate::benito::routing::policy::RoutingHints;
use std::sync::{
...
async fn medium_with_local_bias_hint_uses_local() {
    ...
    let hints = RoutingHints {
        latency_budget: crate::benito::routing::policy::LatencyBudget::Low,
        ..Default::default()
    };
...
async fn history_lightweight_uses_local_when_healthy() {
    use crate::benito::inference::provider::traits::ChatMessage;
...
async fn tools_present_forces_remote_even_when_local_healthy_and_lightweight() {
    use crate::benito::inference::provider::traits::{ChatMessage, ChatRequest};
