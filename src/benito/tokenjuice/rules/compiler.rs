...
use crate::benito::tokenjuice::types::{
...
mod tests {
    use super::*;
    use crate::benito::tokenjuice::types::{JsonRule, RuleMatch};
    ...
    fn invalid_regex_is_dropped_not_panicked() {
        use crate::benito::tokenjuice::types::{RuleCounter, RuleFilters};
    ...
    fn case_insensitive_flag() {
        use crate::benito::tokenjuice::types::RuleCounter;
    ...
    fn invalid_regex_in_keep_patterns_is_dropped() {
        use crate::benito::tokenjuice::types::RuleFilters;
    ...
    fn invalid_regex_in_match_output_is_dropped() {
        use crate::benito::tokenjuice::types::RuleOutputMatch;
