use super::*;
use crate::benito::tokenjuice::rules::load_builtin_rules;
...
fn match_output_pattern_returns_canned_message() {
    ...
    let rule = crate::benito::tokenjuice::types::JsonRule {
    ...
    let compiled = compile_rule(
        rule,
        crate::benito::tokenjuice::types::RuleOrigin::Builtin,
...
fn on_empty_returns_custom_message() {
    use crate::benito::tokenjuice::{rules::compiler::compile_rule, types::RuleMatch};
    ...
    let rule = crate::benito::tokenjuice::types::JsonRule {
        ...
        counter_source: None,
        r#match: RuleMatch::default(),
        filters: Some(crate::benito::tokenjuice::types::RuleFilters {
...
fn pretty_print_json_transform_works() {
    ...
    let rule = crate::benito::tokenjuice::types::JsonRule {
        ...
        r#match: RuleMatch::default(),
        filters: None,
        transforms: Some(crate::benito::tokenjuice::types::RuleTransforms {
...
fn head_tail_zero_head() {
    use crate::benito::tokenjuice::text::head_tail;
