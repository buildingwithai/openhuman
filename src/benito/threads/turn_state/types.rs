...
use crate::benito::agent::task_board::TaskBoard;
...
/// Request payload for `Benito.threads_turn_state_get`.
...
/// Response payload for `Benito.threads_turn_state_get`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Response payload for `Benito.threads_turn_state_list`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Request payload for `Benito.threads_turn_state_clear`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
...
/// Response payload for `Benito.threads_turn_state_clear`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
