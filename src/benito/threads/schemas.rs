...
use crate::benito::agent::task_board::{TaskBoard, TaskBoardCard, TaskBoardStore};
...
use crate::benito::threads::turn_state::{ClearTurnStateRequest, GetTurnStateRequest};
...
fn handle_task_board_get(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let board = crate::benito::agent::task_board::board_for_thread(
