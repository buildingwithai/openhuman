...
//!
//! Benito's inference backend does automatic prefix caching, so we
...
use crate::benito::inference::provider::ConversationMessage;
...
mod tests {
    use super::*;
    use crate::benito::inference::provider::{ChatMessage, ToolCall, ToolResultMessage};
