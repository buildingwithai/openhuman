//! Compat shim — prompt plumbing has moved to [`crate::benito::agent::prompts`].
//!
...
//! the rest of the tree — `use crate::benito::context::prompt::...`
//! keeps working unchanged.

pub use crate::benito::agent::prompts::*;
