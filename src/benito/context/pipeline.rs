...
//!    Benito's existing `auto_compact_history` lives in
...
//!    [`crate::benito::context::session_memory`].
//!
//! # Cache contract
//!
...
use crate::benito::inference::provider::{ConversationMessage, UsageInfo};
...
impl ContextPipeline {
    ...
    /// observability / [`crate::benito::context::ContextStats`].
