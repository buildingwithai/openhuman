...
//!
//! Three detectors feed [`crate::benito::learning::candidate::global()`]:
//!
...
//! intended to be called from [`crate::benito::learning::ReflectionHook`] or a
...
mod heuristics_tests {
    use super::*;
    use crate::benito::learning::candidate::{Buffer, FacetClass};
