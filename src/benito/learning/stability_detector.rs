...
use crate::benito::learning::candidate::{self, CueFamily, FacetClass, LearningCandidate};
use crate::benito::memory::store::profile::{FacetState, FacetType, ProfileFacet, UserState};
...
impl StabilityDetector {
    ...
    pub fn rebuild(&self, now: f64) -> anyhow::Result<RebuildOutcome> {
        ...
        for key in existing_by_key.keys() {
            if let Some(class) = crate::benito::learning::cache::class_from_key(key) {
        ...
        for ((class, full_key), cands) in &groups {
            ...
            let new_refs: Vec<crate::benito::learning::candidate::EvidenceRef> =
...
fn class_prefix(class: FacetClass) -> &'static str {
    crate::benito::learning::cache::class_prefix(class)
}
...
mod tests {
    use super::*;
    use crate::benito::learning::cache::FacetCache;
    use crate::benito::learning::candidate::{
    ...
    fn rebuild_pinned_facet_stays_active_regardless_of_stability() {
        ...
        use crate::benito::memory::store::profile::{FacetState, FacetType, UserState};
