...
pub async fn start_hosted_dir_server(
    ...
    let auth = if params.disable_auth {
        ...
        let username = params
            ...
            .or(default_username);
        let username =
            sanitize_basic_auth_username(username).unwrap_or_else(|| "Benito".to_string());
