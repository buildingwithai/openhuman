...
use crate::benito::http_host::auth::ensure_authorized;
...
use crate::benito::http_host::types::HostedDirAuth;
    ...
    match tokio::fs::read_dir(dir).await {
        Ok(mut entries) => {
            ...
            let mut html = String::from(
                "<!doctype html><html><head><meta charset=\"utf-8\"><title>Benito Directory Listing</title></head><body>",
            );
