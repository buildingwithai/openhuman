...
use crate::benito::about_app::CapabilityCategory;
...
fn handle_about_app_list(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::benito::about_app::list_capabilities(category))
    })
}
...
fn handle_about_app_lookup(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::benito::about_app::lookup_capability(&payload.id)?)
    })
}
...
fn handle_about_app_search(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::benito::about_app::search_capabilities(
            &payload.query,
        ))
    })
}
