...
//! Tauri shell crate (`Benito` crate at `app/src-tauri/` —
//! `tauri_runtime_cef::notification::register`). This domain owns the
//! shared wire types, the title-formatting contract (`Benito:`
...
pub use dispatch::{format_title, BENITO_TITLE_PREFIX};
pub use schemas::{
