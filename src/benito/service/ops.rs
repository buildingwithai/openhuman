...
use crate::benito::service::daemon_host::DaemonHostConfig;
use crate::benito::service::{self, daemon_host, ServiceStatus};
use crate::rpc::RpcOutcome;

/// Installs the Benito daemon as a system service.
...
/// Starts the installed Benito daemon service.
...
/// Stops the running Benito daemon service.
...
/// Returns the current status of the Benito daemon service.
...
/// Uninstalls the Benito daemon system service.
