...
const RESTART_DELAY_ENV: &str = "BENITO_RESTART_DELAY_MS";
...
/// performed by [`crate::benito::service::bus::RestartSubscriber`] so every
...
/// `Benito run --jsonrpc-only` or another long-lived server mode.
