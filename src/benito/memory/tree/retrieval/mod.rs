...
//! - `Benito.memory_tree_query_source`   — per-source summary retrieval
//! - `Benito.memory_tree_query_global`   — cross-source digest for a window
//! - `Benito.memory_tree_query_topic`    — entity-scoped retrieval
//! - `Benito.memory_tree_search_entities` — fuzzy canonical-id lookup
//! - `Benito.memory_tree_drill_down`     — walk summary children
//! - `Benito.memory_tree_fetch_leaves`   — batch chunk hydration
//!
