...
use crate::benito::memory::tree::score::store::{lookup_entity, EntityHit};
use crate::benito::memory::tree::tree_source::store;
use crate::benito::memory::tree::tree_source::types::{Tree, TreeKind};
...
async fn rerank_by_semantic_similarity(
    ...
    use crate::benito::memory::tree::store::get_chunk_embedding;
...
async fn entity_hit_to_retrieval_hit(
    ...
    tokio::task::spawn_blocking(move || -> Result<Option<RetrievalHit>> {
        ...
        use crate::benito::memory::tree::retrieval::types::hit_from_chunk;
...
mod tests {
    ...
    async fn duplicate_node_is_deduplicated_across_index_and_topic_tree_root() {
        use crate::benito::memory::tree::score::extract::EntityKind;
        use crate::benito::memory::tree::score::resolver::CanonicalEntity;
