...
//! [`crate::benito::memory::tree::score::embed::pack_embedding`]. New
...
use crate::benito::memory::tree::content_store::StagedSummary;
use crate::benito::memory::tree::score::embed::{decode_optional_blob, pack_checked};
...
/// [`crate::benito::memory::tree::store::tree_active_signature`] — same
...
pub fn set_summary_embedding(
    ...
    let signature = crate::benito::memory::tree::store::tree_active_signature(config);
    log::debug!(
