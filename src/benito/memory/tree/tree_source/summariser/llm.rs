...
//! [`crate::benito::memory::tree::score::extract::llm::LlmEntityExtractor`].
//!
//! ## Responsibility
//!
...
use crate::benito::learning::extract::summary_facets::{self, StructuredSummary};
use crate::benito::memory::tree::chat::{ChatPrompt, ChatProvider};
