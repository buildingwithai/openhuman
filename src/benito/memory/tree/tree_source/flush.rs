...
use crate::benito::memory::tree::tree_source::bucket_seal::{cascade_all_from, LabelStrategy};
use crate::benito::memory::tree::tree_source::store;
use crate::benito::memory::tree::tree_source::summariser::Summariser;
use crate::benito::memory::tree::tree_source::types::DEFAULT_FLUSH_AGE_SECS;
...
mod tests {
    ...
    use crate::benito::memory::tree::tree_source::bucket_seal::{append_leaf, LeafRef};
    ...
    async fn flush_does_not_force_seal_under_fanout_upper_buffer() {
        ...
        crate::benito::memory::tree::store::with_connection(&cfg, |conn| {
            let tx = conn.unchecked_transaction()?;
            crate::benito::memory::tree::tree_source::store::upsert_buffer_tx(
                &tx,
                &crate::benito::memory::tree::tree_source::types::Buffer {
