...
use crate::benito::memory::tree::score::extract::{EntityKind, ExtractedEntities};
...
mod tests {
    use super::*;
    use crate::benito::memory::tree::score::extract::ExtractedEntity;
    ...
    use crate::benito::memory::tree::score::extract::ExtractedTopic;
