...
use crate::benito::memory::store::events::EVENTS_INIT_SQL;
use crate::benito::memory::store::fts5;
use crate::benito::memory::store::profile::PROFILE_INIT_SQL;
use crate::benito::memory::store::segments::SEGMENTS_INIT_SQL;
...
async fn e2e_stm_recall_chain() {
    ...
    struct StubChat;
    use crate::benito::memory::tree::chat::ChatProvider;
    ...
    use crate::benito::memory::tree::score::embed::InertEmbedder;
    let chat_provider: Arc<dyn crate::benito::memory::tree::chat::ChatProvider> =
        Arc::new(StubChat);
    let embedder: Arc<dyn crate::benito::memory::tree::score::embed::Embedder> =
