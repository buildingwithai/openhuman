...
use crate::benito::memory::store::GraphRelationRecord;
...
/// It does **not** fall back to `~/.Benito/workspace`; that hazard is the
/// one [`crate::benito::memory::global::client`] guards against, and it
