...
/// [`crate::benito::memory::IngestionStatusSnapshot`] but is the public RPC
...
///
/// Ingestion in Benito is listener/webhook-driven — there is no per-provider
...
pub async fn memory_ingestion_status() -> Result<RpcOutcome<IngestionStatusResult>, String> {
    let snapshot = match crate::benito::memory::global::client_if_ready() {
