...
Benito already supports MCP servers as tools, but that path is
...
(Claude Code, Cursor, Codex, OpenCode, plus Benito) share a single
durable memory.
...
| Benito `MemoryEntry` | agentmemory wire |
|---|---|
