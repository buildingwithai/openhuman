//! `impl Memory for AgentMemoryBackend` — the hot path for Benito <→
//! agentmemory traffic.
//!
...
//! module pins the Benito-visible projection of that contract; the
...
use crate::benito::config::MemoryConfig;
