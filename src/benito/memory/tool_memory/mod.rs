...
//! [issue #1400](https://github.com/tinyhumansai/Benito/issues/1400):
//! a first-class storage and retrieval surface for **actionable**
//! tool-specific guidance, distinct from the
//! [`tool_effectiveness`](crate::benito::learning::tool_tracker)
...
//!
//! [`PostTurnHook`]: crate::benito::agent::hooks::PostTurnHook
