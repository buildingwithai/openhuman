...
//! `tool_effectiveness`.
//!
//! [`ToolTrackerHook`]: crate::benito::learning::ToolTrackerHook
...
use crate::benito::agent::hooks::{PostTurnHook, ToolCallRecord, TurnContext};
...
mod tests {
    use super::*;
    use crate::benito::agent::hooks::ToolCallRecord;
    use crate::benito::memory::tool_memory::store::ToolMemoryStore;
    use crate::benito::memory::tool_memory::test_helpers::MockMemory;
    ...
    async fn safety_case_never_email_sarah_pins_into_prompt_block() {
        ...
        let rendered = crate::benito::memory::tool_memory::render_tool_memory_rules(&flat);
