...
//! [`crate::benito::agent::prompts::SystemPromptBuilder::build`]).
//!
...
//! the pattern used by
//! [`crate::benito::agent::prompts::ReflectionMemoryContextSection`].
...
mod tests {
    use super::*;
    use crate::benito::agent::prompts::types::{
        LearnedContextData, PromptContext, ToolCallFormat,
    };
    use crate::benito::memory::tool_memory::types::ToolMemorySource;
