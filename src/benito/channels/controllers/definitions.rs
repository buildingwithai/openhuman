    ...
    ChannelDefinition {
        ...
        auth_modes: vec![
            AuthModeSpec {
                ...
                description: "Message the Benito Telegram bot directly.",
                fields: vec![],
    ...
    ChannelDefinition {
        ...
        auth_modes: vec![
            ...
            AuthModeSpec {
                ...
                description: "Install the Benito bot to your Discord server via OAuth.",
                fields: vec![],
                auth_action: Some("discord_oauth"),
            },
            AuthModeSpec {
                mode: ChannelAuthMode::ManagedDm,
                description: "Link your personal Discord account to the Benito bot.",
                fields: vec![],
...
fn imessage_definition() -> ChannelDefinition {
    ChannelDefinition {
        ...
        auth_modes: vec![AuthModeSpec {
            mode: ChannelAuthMode::ManagedDm,
            description: "Local-only — no credentials. Grant Full Disk Access to Benito.",
...
/// already implemented in `src/Benito/channels/providers/lark.rs`; this
...
/// implemented in `src/Benito/channels/providers/dingtalk.rs`. See #2048.
