use crate::benito::channels::{traits, Channel, SendMessage};
...
// `crate::benito::agent::bus` as `BUS_HANDLER_LOCK` (re-exported from
...
// `crate::benito::agent::bus`) or the generic `mock_bus_stub` in
// `crate::core::event_bus::testing` for arbitrary bus methods.
pub(super) use crate::benito::agent::bus::use_real_agent_handler;
