use crate::benito::channels::traits::{Channel, ChannelMessage, SendMessage};
...
pub struct LarkChannel {
    ...
    receive_mode: crate::benito::config::schema::LarkReceiveMode,
...
impl LarkChannel {
    pub fn new(
        ...
        Self {
            ...
            allowed_users,
            use_feishu: true,
            receive_mode: crate::benito::config::schema::LarkReceiveMode::default(),
    ...
    pub fn from_config(config: &crate::benito::config::schema::LarkConfig) -> Self {
        let mut ch = Self::new(
            config.app_id.clone(),
    ...
    fn http_client(&self) -> reqwest::Client {
        crate::benito::config::build_runtime_proxy_client("channel.lark")
    }
...
impl Channel for LarkChannel {
    ...
    async fn listen(&self, tx: tokio::sync::mpsc::Sender<ChannelMessage>) -> anyhow::Result<()> {
        use crate::benito::config::schema::LarkReceiveMode;
