...
fn issue_1041_transcript_preserves_bullets_and_trailing_paragraphs() {
    ...
    let text = "here's the full message with a sharper CTA:\n\n\
        ...
        i'm reaching out to share what we're building at TinyHumans. we just launched Benito, and the insight is simple: AI agents are incredibly powerful, but today they're locked behind developer workflows. setup, API keys, terminals. the 99% who can't code are completely left out.\n\n\
        Benito fixes that. it's AI agents that work out of the box. no setup, no API keys, no copy-paste. just plain English.\n\n\
