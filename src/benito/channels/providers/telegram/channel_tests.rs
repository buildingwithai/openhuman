...
use crate::benito::config::StreamMode;
use std::path::Path;
...
fn telegram_extract_bind_code_supports_bot_mention() {
    assert_eq!(
        TelegramChannel::extract_bind_code("/bind@BENITO_bot 654321"),
        Some("654321")
    );
}
...
async fn test_thinking_placeholder_logic() {
    ...
    use crate::benito::channels::traits::Channel;
    use crate::benito::channels::SendMessage;
    ...
    impl Channel for MockTelegramChannel {
        ...
        async fn listen(
            &self,
            _: tokio::sync::mpsc::Sender<crate::benito::channels::traits::ChannelMessage>,
        ) -> anyhow::Result<()> {
            Ok(())
        }
