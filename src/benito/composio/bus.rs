...
//!   [`crate::benito::agent::triage::run_triage`] to produce a
//!   [`TriageDecision`] and then
//!   [`crate::benito::agent::triage::apply_decision`] to act on it.
...
//!   the bus.
//!
//! [trigger_triage]: crate::benito::agent::agents
//!
//! ## Feature flag
//!
//! The triage path is gated on `BENITO_TRIGGER_TRIAGE_DISABLED` (set
...
use crate::benito::agent::triage::{apply_decision, run_triage, TriageOutcome, TriggerEnvelope};
use crate::benito::composio::trigger_history;
...
const TRIAGE_DISABLED_ENV: &str = "BENITO_TRIGGER_TRIAGE_DISABLED";
...
/// Returns `true` when `BENITO_TRIGGER_TRIAGE_DISABLED` is set to a
