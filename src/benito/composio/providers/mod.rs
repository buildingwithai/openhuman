...
//! `tinyhumansai/Benito-skills`, but specialized for Composio's API
...
use crate::benito::composio::types::ComposioCapability;
...
/// it is an observability surface for Benito's own capability tiers. Use
