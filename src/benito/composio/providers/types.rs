...
use crate::benito::composio::types::ComposioExecuteResponse;
...
/// migration in [`crate::benito::composio::tools::ComposioExecuteTool`].
#[derive(Clone)]
...
impl ProviderContext {
    ...
    pub fn memory_client(&self) -> Option<crate::benito::memory::MemoryClientRef> {
        #[cfg(test)]
        {
            return crate::benito::memory::MemoryClient::from_workspace_dir(
        ...
        #[cfg(not(test))]
        crate::benito::memory::global::client_if_ready()
    }
}
...
mod tests {
    ...
    // the factory — the live on-disk config under `BENITO_WORKSPACE`
