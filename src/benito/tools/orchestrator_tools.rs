...
//!
//! Called from [`crate::benito::agent::harness::session::builder`] at
...
//!
//! [`AgentDefinition::when_to_use`]: crate::benito::agent::harness::definition::AgentDefinition::when_to_use
//! [`SubagentEntry::AgentId`]: crate::benito::agent::harness::definition::SubagentEntry::AgentId
//! [`SubagentEntry::Skills`]: crate::benito::agent::harness::definition::SubagentEntry::Skills

use crate::benito::agent::harness::definition::{
    AgentDefinition, AgentDefinitionRegistry, SubagentEntry,
};
use crate::benito::context::prompt::ConnectedIntegration;

// SpawnWorkerThreadTool import kept commented while the worker-thread spawn is
// temporarily disabled (see tinyhumansai/Benito#1624).
...
pub fn collect_orchestrator_tools(
    ...
    // showcase (see tinyhumansai/Benito#1624). Re-enable once the
    ...
    fn collects_agentid_entries_and_collapses_skills_wildcard() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                // see tinyhumansai/Benito#1624. Re-add the leading entry
