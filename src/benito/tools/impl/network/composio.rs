...
//
// When enabled, Benito can execute actions on Gmail, Notion, GitHub, Slack, etc.
...
impl ComposioTool {
    ...
    fn client(&self) -> Client {
        crate::benito::config::build_runtime_proxy_client_with_timeouts("tool.composio", 60, 10)
    }
...
fn sanitize_error_message(message: &str) -> String {
    ...
    crate::benito::util::truncate_with_ellipsis(&sanitized, 240)
}
