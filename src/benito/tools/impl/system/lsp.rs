...
//! 2. The gate is observable: with `BENITO_LSP_ENABLED=1` set the
...
pub const LSP_ENABLED_ENV: &str = "BENITO_LSP_ENABLED";
...
impl Tool for LspTool {
    ...
    fn description(&self) -> &str {
        "Query a Language Server for code intelligence (definition, references, \
         ...
         BENITO_LSP_ENABLED=1. The server-spawning backend is a follow-up \
