...
//! [`crate::benito::javascript::NodeBootstrap`] for binary resolution.
//! Same security posture as
//! [`crate::benito::tools::impl::system::shell::ShellTool`] and
//! [`crate::benito::tools::impl::system::node_exec::NodeExecTool`]:
//!
