...
//! restart of the Benito core binary.
//!
//! Wraps [`crate::benito::update::rpc::update_run`] so the LLM can
...
impl UpdateApplyTool {
    ...
    /// `[Benito:policy]` log format and would silently miss any
...
impl Tool for UpdateApplyTool {
    ...
    fn description(&self) -> &str {
        "Download, verify, and stage the latest Benito core binary, then \
