...
use crate::benito::whatsapp_data::rpc as whatsapp_rpc;
use crate::benito::whatsapp_data::types::SearchMessagesRequest;
...
mod tests {
    use super::*;
    use crate::benito::tools::traits::{PermissionLevel, ToolScope};
