...
impl FieldBounds {
    pub fn from_element(b: &crate::benito::accessibility::ElementBounds) -> Self {
        Self {
            x: b.x,
            y: b.y,
            width: b.width,
    ...
    pub fn to_element(&self) -> crate::benito::accessibility::ElementBounds {
        crate::benito::accessibility::ElementBounds {
            x: self.x,
            y: self.y,
            width: self.width,
            height: self.height,
...
mod tests {
    use super::*;
    use crate::benito::accessibility::ElementBounds;
    use serde_json::json;
