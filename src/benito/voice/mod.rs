...
//!
//! Provides RPC endpoints under the `Benito.voice_*` namespace for
...
//! `crate::benito::inference::voice` so all inference concerns share a
//! single domain root.
...
pub use crate::benito::inference::voice::cloud_transcribe;
pub use crate::benito::inference::voice::hallucination;
pub use crate::benito::inference::voice::local_speech;
pub use crate::benito::inference::voice::local_transcribe;
pub use crate::benito::inference::voice::postprocess;
pub use crate::benito::inference::voice::streaming;
