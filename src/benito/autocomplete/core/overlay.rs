...
use crate::benito::accessibility::{self, ElementBounds};
...
pub(super) fn show_overflow_badge(
    ...
    #[cfg(target_os = "macos")]
    {
        ...
        let title = match kind {
            "ready" => "Benito suggestion",
            "accepted" => "Benito applied",
            "rejected" => "Benito dismissed",
            "error" => "Benito autocomplete error",
            _ => "Benito autocomplete",
        };
...
mod tests {
    ...
    fn show_overflow_badge_non_macos_does_not_panic_ready() {
        let bounds = crate::benito::accessibility::ElementBounds {
            x: 0,
            y: 0,
            width: 100,
            height: 50,
