...
pub async fn autocomplete_history(
    ...
    let entries = crate::benito::autocomplete::history::list_history(requested_limit).await?;
...
pub async fn autocomplete_clear_history(
    ...
    let cleared = crate::benito::autocomplete::history::clear_history().await?;
    Ok(RpcOutcome::new(
...
mod tests {
    ...
    // MemoryClient::new_local() (resolves to default_root_BENITO_dir()).
