...
mod tests {
    ...
    async fn initialize_echoes_supported_protocol_and_tools_capability() {
        ...
        assert_eq!(response["result"]["serverInfo"]["name"], "Benito-core");
    }
