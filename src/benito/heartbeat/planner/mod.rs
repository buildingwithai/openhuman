...
use crate::benito::notifications::bus::publish_core_notification;
use crate::benito::notifications::types::CoreNotificationEvent;
...
mod tests {
    use super::*;
    use crate::benito::config::Config;
    use crate::benito::cron::{self, Schedule};
    use crate::benito::notifications::subscribe_core_notifications;
    use chrono::TimeZone;
    use serde_json::json;
