...
use crate::benito::config::{self, Config};
...
pub async fn settings_set(
    ...
    if config.heartbeat.enabled {
        ...
        if let Err(error) = crate::benito::subconscious::global::bootstrap_after_login().await {
        ...
        crate::benito::subconscious::global::stop_heartbeat_loop().await;
    }
