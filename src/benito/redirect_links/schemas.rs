...
use crate::benito::redirect_links::ops as rl_ops;
...
pub fn schemas(function: &str) -> ControllerSchema {
    match function {
        "shorten" => ControllerSchema {
            ...
            function: "shorten",
            description: "Persist a long URL and return its `Benito://link/<id>` short form.",
        ...
        "expand" => ControllerSchema {
            ...
            inputs: vec![FieldSchema {
                name: "id",
                ty: TypeSchema::String,
                comment: "The short id (the hex portion after `Benito://link/`).",
                required: true,
            }],
            outputs: vec![FieldSchema {
                name: "link",
        ...
        "rewrite_inbound" => ControllerSchema {
            ...
            description:
                "Rewrite every long URL in `text` to an `Benito://link/<id>` placeholder \
        ...
        "rewrite_outbound" => ControllerSchema {
            ...
            description:
                "Expand every `Benito://link/<id>` placeholder in `text` back to its full \
