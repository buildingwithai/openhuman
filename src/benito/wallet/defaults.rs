...
pub fn env_var_for_chain(chain: WalletChain) -> &'static str {
    match chain {
        WalletChain::Evm => "BENITO_WALLET_RPC_EVM",
        WalletChain::Btc => "BENITO_WALLET_RPC_BTC",
        WalletChain::Solana => "BENITO_WALLET_RPC_SOLANA",
        WalletChain::Tron => "BENITO_WALLET_RPC_TRON",
    }
}
