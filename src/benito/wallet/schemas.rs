        ...
        "setup" => ControllerSchema {
            ...
            inputs: vec![
                ...
                FieldSchema {
                    ...
                    comment:
                        "Encrypted recovery phrase payload created via Benito.encrypt_secret. Required for on-chain signing/broadcast.",
                    required: true,
                },
                required_json(
                    "accounts",
...
fn handle_setup(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        crate::benito::wallet::setup(WalletSetupParams {
